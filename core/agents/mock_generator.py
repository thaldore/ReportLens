...
def create_mock_generator(model: Ollama) -> Agent:
    return Agent(
        ...
        instructions=[
            ...
            "| 2 | Ogrenci memnuniyet anketi uygulanmis mi? | 2 | [ ] |",
            "| 3 | Kalite guvence mekanizmalari olusturulmus mu? | 3 | [X] |",
            "| 4 | Arastirma projeleri aktif olarak izleniyor mu? | 1 | [ ] |",
            "| 5 | Mezun takip sistemi mevcut mu? | 5 | [X] |",
            "",
            "## BOLUM 2: METIN BEYANLARI",
            "",
            "Fakultede 5 bolum bulunmakta olup toplam 730 ogrenci kayitlidir. [GT:DOGRU]",
            "",
            ...
            "",
            "Birim danisma kurulu yilda 4 kez toplanmistir. [GT:YANLIS]",
            "",
            "### CRITICAL RULES:",
            ...
            "7. YOU MUST GENERATE BOTH SECTIONS. Do not skip either section.",
        ],
    )
